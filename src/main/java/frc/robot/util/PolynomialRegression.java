// The original file can be downloaded from https://algs4.cs.princeton.edu/14analysis/PolynomialRegression.java
 ...
 * on an set of <em>N</em> data points (<em>y<sub>i</sub></em>,
 * <em>x<sub>i</sub></em>).
 ...
 * It also computes associated the coefficient of determination
 * <em>R</em><sup>2</sup>.
 * <p>
